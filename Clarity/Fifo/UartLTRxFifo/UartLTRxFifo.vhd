...
-- Module  Version: 5.8
--C:\lscc\diamond\3.11_x64\ispfpga\bin\nt64\scuba.exe -w -n UartLTRxFifo -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00g -type ebfifo -depth 2048 -width 10 -rwidth 10 -regout -reset_rel SYNC -pe 2 -pf 2000 -rfill -fill -fdc C:/Project/2020/Refael/Lightning/Vhdl/Ver2_1/Clarity/Fifo/UartLTRxFifo/UartLTRxFifo.fdc 

-- Mon Nov 01 15:49:34 2021
...
architecture Structure of UartLTRxFifo is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_1 : label is "UartLTRxFifo.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_0_1 : label is "";
    attribute MEM_LPC_FILE of pdp_ram_0_1_0 : label is "UartLTRxFifo.lpc";
...
begin
    ...
    pdp_ram_0_1_0: DP16KD
        ...
        port map (DIA17=>scuba_vlo, DIA16=>scuba_vlo, DIA15=>scuba_vlo, 
            ...
            DIA2=>scuba_vlo, DIA1=>scuba_vlo, DIA0=>Data(9), 
            ...
            OCEB=>scuba_vhi, CLKB=>RdClock, WEB=>scuba_vlo, 
            ...
            DOB10=>open, DOB9=>open, DOB8=>open, DOB7=>open, DOB6=>open, 
    ...
    wfill_4: CCU2C
        ...
        port map (A0=>wptr_7, A1=>wptr_8, B0=>rcount_w7, 
            ...
            D0=>scuba_vhi, D1=>scuba_vhi, CIN=>co3_2, S0=>wfill_sub_7, 
            S1=>wfill_sub_8, COUT=>co4_2);
    ...
    wfill_6: CCU2C
        ...
        port map (A0=>wfill_sub_msb, A1=>scuba_vlo, B0=>scuba_vlo, 
            B1=>scuba_vlo, C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, 
            D1=>scuba_vhi, CIN=>co5_2, S0=>wfill_sub_11, S1=>open, 
            COUT=>open);

    precin_inst319: CCU2C
        generic map (INJECT1_1=> "NO", INJECT1_0=> "NO", INIT1=> X"0000", 
        INIT0=> X"0000")
        port map (A0=>scuba_vhi, A1=>scuba_vhi, B0=>scuba_vhi, 
            B1=>scuba_vhi, C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, 
    ...
    rfill_6: CCU2C
        ...
        port map (A0=>rfill_sub_msb, A1=>scuba_vlo, B0=>scuba_vlo, 
            B1=>scuba_vlo, C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, 
            D1=>scuba_vhi, CIN=>co5_3, S0=>rfill_sub_11, S1=>open, 
            COUT=>open);
    ...
    empty_cmp_5: CCU2C
        ...
        port map (A0=>rcount_10, A1=>empty_cmp_set, B0=>wcount_r10, 
            ...
            D0=>scuba_vhi, D1=>scuba_vhi, CIN=>co4_4, S0=>open, S1=>open, 
            COUT=>empty_d_c);
    ...
    ae_set_ctr_1: CCU2C
        ...
        port map (A0=>ae_setcount_2, A1=>ae_setcount_3, B0=>scuba_vlo, 
            B1=>scuba_vlo, C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, 
            D1=>scuba_vhi, CIN=>co0_6, S0=>iae_setcount_2, 
            S1=>iae_setcount_3, COUT=>co1_6);
    ...
    ae_set_ctr_2: CCU2C
        ...
        port map (A0=>ae_setcount_4, A1=>ae_setcount_5, B0=>scuba_vlo, 
            B1=>scuba_vlo, C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, 
            D1=>scuba_vhi, CIN=>co1_6, S0=>iae_setcount_4, 
            S1=>iae_setcount_5, COUT=>co2_6);
    ...
    ae_set_ctr_3: CCU2C
        ...
        port map (A0=>ae_setcount_6, A1=>ae_setcount_7, B0=>scuba_vlo, 
            B1=>scuba_vlo, C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, 
            D1=>scuba_vhi, CIN=>co2_6, S0=>iae_setcount_6, 
            S1=>iae_setcount_7, COUT=>co3_6);
    ...
    ae_set_ctr_4: CCU2C
        ...
        port map (A0=>ae_setcount_8, A1=>ae_setcount_9, B0=>scuba_vlo, 
            B1=>scuba_vlo, C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, 
            D1=>scuba_vhi, CIN=>co3_6, S0=>iae_setcount_8, 
            S1=>iae_setcount_9, COUT=>co4_6);
    ...
    ae_set_ctr_5: CCU2C
        ...
        port map (A0=>ae_setcount_10, A1=>ae_setcount_11, B0=>scuba_vlo, 
            B1=>scuba_vlo, C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, 
            D1=>scuba_vhi, CIN=>co4_6, S0=>iae_setcount_10, 
            S1=>iae_setcount_11, COUT=>co5_4);
